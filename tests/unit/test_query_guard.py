...
def test_query_guard_accepts_read_only_statements(source: str) -> None:
    assert validate_read_only(source).endswith(";")
...
def test_query_guard_rejects_mutation_and_procedural_sql(source: str) -> None:
