...
| UOW-005 Governance, Reference Data, Demo, and Proposal Hardening | All units | Yes, ongoing | Reference data, sample scenarios, tests, and proposal materials should guide each unit from the start. |
